...
router.post('/', (req, res) => {
    ...
    res.send('create a new user if they do not already exist in the db, log a user in')
})
...
router.post('/login', (req, res) => {
    res.send('verify credentials that are given by user to log in')
})
...
router.get('/profile', (req, res) => {
    res.send('show the currently logged in user their personal profile')
})
